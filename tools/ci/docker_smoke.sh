...
# Substitute: magent-battle, coworld-magent-battle, 2.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-magent-battle:ci)
#   SMOKE_SLUG                 game slug                        (magent-battle)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/magent-battle)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/magent-battle-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-magent-battle:ci}}"
slug="${SMOKE_SLUG:-magent-battle}"
